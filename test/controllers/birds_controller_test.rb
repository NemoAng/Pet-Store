...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { age: @bird.age, description: @bird.description, name: @bird.name, price: @bird.price } }
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { age: @bird.age, description: @bird.description, name: @bird.name, price: @bird.price } }
