...
class DogBreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog_breed" do
    assert_difference('DogBreed.count') do
      post dog_breeds_url, params: { dog_breed: { description: @dog_breed.description, name: @dog_breed.name } }
    end
  ...
  test "should update dog_breed" do
    patch dog_breed_url(@dog_breed), params: { dog_breed: { description: @dog_breed.description, name: @dog_breed.name } }
