...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { age: @dog.age, description: @dog.description, name: @dog.name, price: @dog.price } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { age: @dog.age, description: @dog.description, name: @dog.name, price: @dog.price } }
